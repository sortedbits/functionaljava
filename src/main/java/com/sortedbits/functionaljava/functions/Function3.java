...
public interface Function3<T1, T2, T3, R> extends Function {
    ...
    default Function2<T2, T3, R> appliedPartially(T1 x1) {
        return (x2, x3) -> apply(x1, x2, x3);
    }

    default Function1<T3, R> appliedPartially(T1 x1, T2 x2) {
        return x3 -> apply(x1, x2, x3);
    }

    static <T1, T2, T3, R> Function3<T1, T2, T3, R> fromTupled(Function1<Tuple3<T1, T2, T3>, R> f) {
        return (x1, x2, x3) -> f.apply(Tuple.of(x1, x2, x3));
    }

    static <T1, T2, T3, R> Function3<T1, T2, T3, R> fromCurried(Function1<T1, Function1<T2, Function1<T3, R>>> f) {
