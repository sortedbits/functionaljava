...
public interface Function4<T1, T2, T3, T4, R> extends Function {
    ...
    default Function3<T2, T3, T4, R> appliedPartially(T1 x1) {
        return (x2, x3, x4) -> apply(x1, x2, x3, x4);
    }
    
    default Function2<T3, T4, R> appliedPartially(T1 x1, T2 x2) {
        return (x3, x4) -> apply(x1, x2, x3, x4);
    }

    default Function1<T4, R> appliedPartially(T1 x1, T2 x2, T3 x3) {
